...
VALUES 	(1,'algorithms and data structures',NULL,0,'algDataStructures.png'),
		(2,'automata theory',NULL,0,'automataTheory.png'),
		(3,'calculus 1 (differential)',NULL,0,'differentialCalculus.png'),
		(4,'calculus 2 (integral)',NULL,0,'integralCalculus.png'),
		(5,'computer architecture',NULL,0,'computerArchitecture.png'),
		(6,'digital logic',NULL,0,'digitalLogic.png'),
		(7,'discrete mathematics',NULL,0,'discreteMath2.png'),
		(8,'introductory programming',NULL,0,'helloWorld!.png'),
		(9,'linear algebra',NULL,0,'linearAlgebra2.png'),
		(10,'machine learning',NULL,0,'machineLearning.png'),
		(11,'object oriented programming',NULL,0,'OOP2.png'),
		(12,'operating system concepts',NULL,0,'osConcepts.png'),
		(13,'organization of programming languages',NULL,0,'organizationOfProgrammingLanguages.png'),
		(14,'physics mechanics and heat',NULL,0,'physicsMechanicsAndHeat2.png'),
		(15,'physics electromagnetism and waves',NULL,0,'physicsElectromagnetismAndWaves.png'),
		(16,'probability and statistics',NULL,0,'probAndStatistics.png'),
		(17,'software engineering',NULL,0,'softwareEngineering.png'),
		(18,'database systems', NULL,0,'databaseSystems.png');
