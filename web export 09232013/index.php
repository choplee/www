...
<tr>
<td><img src="redBlackCat12WithText.png" alt="RBCAT" width="190.668" height="46.68" align="center"></img></td>
<td>
<nav>
	<ul>
...
<br>
	...
	<?php
		...
		echo "<input type='submit' value=''> <button type='button'>search</button></form>";
		echo "</td>";
		echo "</tr>";
		echo "<tr>";
		echo "<td>";
		echo "<a href='topics2.php'>full topic list</a>";
		echo "</td>";
		echo "</tr>";
		echo "</table>";
	?>
